...
filename = "eval/steering_idkQA_steer_celeb+eng_neg_results.pkl"
outfilename = "eval/steering_idkQA_steer_celeb+eng_neg_results" + "_evaluated" + ".pkl"

idk_corpus = ["I don't know", "I'm not familiar", "I'm not sure", "I'm not certain", "I'm not confident", "I'm not convinced", "I can't answer this"]
